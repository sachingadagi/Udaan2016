...
require_once "$root/Udaan2016/fms/mappers/NonContingentMapper.php";
$NonContingentMapper = new \Udaan\NonContingentMapper();

$result = ($NonContingentMapper->getAll());
...
<div class="container">
    ...
    <div class="row">
        ...
        <h4><strong>Non Contingent / On Spot Registrations</strong></h4>
        <br>
